...
import 'package:pathly/views/Auth_views/verification_code_view.dart';
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              BlocListener<ForgetPassCubit, ForgetPassStates>(
                listener: (context, state) {
                  if (state is LoadingForgetPassState) {
                    log("loading");
                    Get.dialog(
                      Center(
                  ...
                  } else if (state is SuccessForgetPassState) {
                    Get.back();
                    Get.to(
                  ...
                  } else if (state is FailureForgetPassState) {
                    Get.back();
